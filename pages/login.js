...
return (
    <>
        <header>
            <Image className='mt-5 mx-auto w-[200px] object-contain' src={Logo} alt='HBO Logo'></Image>
        </header>
        <main className='text-white px-5 sm:px-20 h-[90vh] flex items-center justify-center '>
            <div className='w-full'>
                ...
                <form action="" className='flex flex-col p-[30px] sm:p-[60px] max-w-[1200px] mx-auto bg-[#dddddd0f] rounded-xl'>
                    ...
                    <div className='mt-10 flex flex-col gap-3 sm:gap-0 sm:flex-row '>
                        ...
                        <button className={`boton ml-0 ${registrate ? '' : 'sm:ml-5' }`} onClick={registro}> REGISTRATE</button>
                    </div>
