          ...
          <div className={`py-5 px-[36px] md:px-[60px]  h-screen w-fit bg-[#0f0f0f] transition-all duration-100  ${navIsOpen ? 'translate-x-[0%]' : 'translate-x-[-10%] '} overflow-scroll sm:overflow-auto`}>
            <nav className=' w-56 md:w-72'>
              ...
              <ul className='font-normal text-[19px] md:text-2xl'>
                <Link href='/'>
                  <li className='mt-6 link-menu select-none' onClick={navHandler}>Inicio</li>
                </Link>
                <Link href='/series'>
                  <li className='mt-6 link-menu select-none' onClick={navHandler}>Series</li>
                </Link>
                <Link href='/peliculas'>
                  <li className='mt-6 link-menu select-none' onClick={navHandler}>Peliculas</li>
                </Link>
            ...
            <div className='w-full h-[1px] bg-gray-400 mt-8'></div>
            <div className='mt-6 link-menu select-none text-xl flex items-center gap-2 pb-32 sm:pb-0' onClick={desloguear}>Logout <HiLogout className='relative top-[1px]'/> </div>
          </div>
        </aside>
      </> : null}
    </>
