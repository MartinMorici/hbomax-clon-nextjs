  ...
  return (
    <div
      ...
      <div className='absolute bottom-[80px] text-white px-3 pl-[28px] sm:pl-[36px] md:pl-[48px] lg:pl-[60px] w-full'>
        ...
        <p
          className={`text-center sm:text-left max-w-[800px] sm:pr-4 sm:mb-6 ${
            individual
              ? ''
              : ' parrafo text-ellipsis overflow-hidden sm:whitespace-nowrap'
          }  md:text-lg  `}>
          {movie.overview}
        </p>
        <div
          className={`gap-5 items-center ${
            individual ? 'flex justify-center mt-3 sm:justify-start' : 'hidden'
          }  sm:flex`}>
          ...
          {trailer.length > 0 ? (
            <Link
              ...
              <button className='flex items-center justify-center gap-2 px-[20px] bg-[#3e3b44b3] min-h-[4px] min-w-[144px] py-[12px] rounded-[4px] hover:border-[#663399] hover:border-2 hover:bg-black font-semibold'>
