...
export const Tendencia = () => {
  return (
    <div className='pr-4 text-center custom:text-left tracking-[-0,05em] custom:tracking-normal'>
      ...
      <Link href='/series'>
        <button aria-label='Explorar' className='px-[20px] bg-[#3e3b44b3] min-h-[4px] min-w-[144px] py-[10px] rounded-[4px] border-2 border-transparent hover:border-[#663399] hover:border-2 hover:bg-black font-semibold text-white mt-6'>EXPLORA MÁS</button>
      </Link>
    </div>
  );
};
