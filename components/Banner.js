...
const Banner = ({ popularMovies, individual, movie }) => {
  ...
  const settings = {
    ...
    customPaging: (i) => (
      <div className='bgcolor w-2 h-2 mx-0 bg-[#ffffff80] rounded-full '></div>
    ),
  };
    ...
    <div className='group'>
      <Slider {...settings}>
        {individual ? (
          <div
            key={movie.id}
            className='h-[90vh] focus-visible:outline-none relative bg-bannerImg '>
            <div className='absolute h-[90vh] inset-0 bg-bannerImg'></div>
            <Image
              priority
              width={1920}
              height={1200}
              className='h-[90vh] w-full object-cover focus-visible:border-none'
            ...
            <div className='absolute bottom-[80px] text-white px-3 pl-[28px] sm:pl-[36px] md:pl-[48px] lg:pl-[60px] w-full'>
              ...
              <p className={`text-center sm:text-left max-w-[800px] sm:pr-4 sm:mb-6 ${individual ? '' : ' parrafo text-ellipsis overflow-hidden sm:whitespace-nowrap'}  md:text-lg  `}>
                {movie.overview}
              </p>
              <div className={`gap-5 items-center ${individual ? 'flex justify-center mt-3 sm:justify-start' :'hidden' }  sm:flex`}>
                <button className='border-2 border-white rounded-full flex justify-center items-center p-2 hover:border-[#663399] hover:bg-black'>
                  ...
                  <button className='px-[20px] bg-[#3e3b44b3] min-h-[4px] min-w-[144px] py-[12px] rounded-[4px] hover:border-[#663399] hover:border-2 hover:bg-black font-semibold'>
                    TRÁILER
                  </button>
            ...
            return (
              <div
                ...
                <div className='absolute bottom-[80px] text-white px-3 pl-[28px] sm:pl-[36px] md:pl-[48px] lg:pl-[60px] w-full'>
                  ...
                  <p className=' parrafo text-center sm:text-left max-w-[800px] sm:pr-4 sm:mb-6 text-ellipsis overflow-hidden md:text-lg sm:whitespace-nowrap '>
                    {movie.overview}
                  </p>
